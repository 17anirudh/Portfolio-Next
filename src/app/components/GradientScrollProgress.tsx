...
type GradientScrollProgressProps = {
  children: React.ReactNode;
};

export function GradientScrollProgress({ children }: GradientScrollProgressProps) {
  const containerRef = useRef<HTMLDivElement | null>(null);

  return (
    <div
      className='h-dvh overflow-auto px-8 pb-16 pt-16'
      ref={containerRef}
    >
